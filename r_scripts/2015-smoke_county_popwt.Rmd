...
This document contains descriptions and code for estimating daily county-level population-weighted PM ~2.5~ values from gridded estimates of PM ~2.5~. Gridded estimates were calculated using geographically-weighted ridge regression (GWR) and krigging.
