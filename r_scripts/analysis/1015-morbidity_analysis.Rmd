...
plot <- ggplot(resp_cumulative_results, aes(x=time, y=estimate)) +
  ...
  facet_wrap(~out_strata, ncol = 2) +
  ylab("Rate Ratio for a 10 ug/m^3in PM2.5") +
  xlab("Lagged Days") +
  ggtitle("Respiratory with smoke 10 as effect modifier") +
  ryan_theme +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.major.y = element_line(linetype = "dotted"),
        panel.grid.minor = element_blank())
...
plot <- ggplot(cvd_cumulative_results, aes(x=time, y=estimate)) +
  ...
  ylab("Rate Ratio for a 10 ug/m^3in PM2.5") +
  xlab("Lagged Days") +
  ggtitle("Cardiovascular with smoke 10 as a modifier") +
  ryan_theme +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.major.y = element_line(linetype = "dotted"),
        panel.grid.minor = element_blank())
...
plot <- ggplot(cvd_cumulative_results, aes(x=time, y=estimate)) +
  ...
  ylab("Rate Ratio for a 10 ug/m^3in PM2.5") +
  xlab("Lagged Days") +
  ggtitle("Cardiovascular with smoke 15 as a modifier") +
  ryan_theme +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.major.y = element_line(linetype = "dotted"),
        panel.grid.minor = element_blank())
